import { DataFormatter, FormattedProcedureList, ProcedureData } from './types.js';

/**
 * Formats procedure list data in a way optimized for LLMs with context length constraints
 */
export class ProcedureListFormatter implements DataFormatter<ProcedureData[], FormattedProcedureList> {
  /**
